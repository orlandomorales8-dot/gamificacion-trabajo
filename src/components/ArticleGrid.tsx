...
export const ArticleGrid: React.FC<ArticleGridProps> = ({
  ...
  return (
    <section id="articulos" className="space-y-6">
      ...
      <div className="flex flex-col gap-4 pb-2 border-b border-stone-200/80">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center bg-stone-100/90 rounded-xl p-1 border border-stone-200/70 text-xs">
            <button
      ...
      {filtered.length > 0 ? (
        ...
        <div className="py-16 px-4 text-center bg-white rounded-2xl border border-stone-200">
          <div className="w-12 h-12 rounded-2xl bg-stone-100 text-stone-400 flex items-center justify-center mx-auto mb-3">
            <Search className="w-6 h-6" />
          </div>
          <h3 className="text-lg font-bold text-stone-900 font-serif-heading mb-1">
