...
export const ARTICLES: Article[] = [
  {
    ...
    coverAccent: 'from-amber-500/20 via-orange-500/10 to-transparent',
    iconName: 'Brain',
    xpReward: 120,
    featured: true,
    takeaways: [
  ...
  },
  {
    ...
    coverAccent: 'from-emerald-500/20 via-teal-500/10 to-transparent',
    iconName: 'Award',
    xpReward: 100,
    takeaways: [
  ...
  },
  {
    ...
    coverAccent: 'from-blue-500/20 via-indigo-500/10 to-transparent',
    iconName: 'History',
    xpReward: 110,
    takeaways: [
  ...
  },
  {
    ...
    coverAccent: 'from-violet-500/20 via-purple-500/10 to-transparent',
    iconName: 'Sliders',
    xpReward: 90,
    takeaways: [
  ...
  },
  {
    ...
    coverAccent: 'from-cyan-500/20 via-blue-500/10 to-transparent',
    iconName: 'Briefcase',
    xpReward: 110,
    takeaways: [
  ...
  },
  {
    ...
    coverAccent: 'from-rose-500/20 via-pink-500/10 to-transparent',
    iconName: 'Compass',
    xpReward: 130,
    featured: true,
    takeaways: [
